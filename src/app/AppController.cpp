...
void AppController::initialize() {
    ...
    mainWindow_->setCloseToTrayEnabled(false);
    ...
    trayController_ = new TrayController(mainWindow_, this);
    if (trayController_->isAvailable()) {
        connect(trayController_, &TrayController::openRequested, this, [this]() {
            showMainWindow();
        });
        connect(trayController_, &TrayController::exitRequested, this, [this]() {
            requestQuit();
        });
        trayController_->show();
    }

    connect(mainWindow_, &MainWindow::exitRequested, this, [this]() {
        requestQuit();
    });
